...
if __name__ == "__main__":
    ...
    ori_video_dir = f'./data/video/{file_name}' 
    # ori_video_dir = './data/video/video.mp4' 
    result_img_dir = f'./results/real_time/{file_name+"_trained_trt"}/test' # image save directory
    original_img_dir = f'./results/real_time/{file_name+"_trained_trt"}/original_image'
    real_time_img_dir = f'./results/real_time/{file_name+"_trained_trt"}/real_time_image'
