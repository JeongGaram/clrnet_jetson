...
if __name__ == "__main__":
    ...
    result_img_dir = f'./results/real_time/{file_name+"_trained_onnx_cpu"}/test' # image save directory
    original_img_dir = f'./results/real_time/{file_name+"_trained_onnx_cpu"}/original_image'
    ...
    while(cap.isOpened()):
        ...
        print(f'{end-start} sec, fps : {1/(end-start)}')
        img_count += 1
