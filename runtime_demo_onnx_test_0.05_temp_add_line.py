...
if __name__ == "__main__":
    ...
    result_img_dir = f'./results/real_time/{file_name+"_onnx"}/test' # image save directory
    original_img_dir = f'./results/real_time/{file_name+"_onnx"}/original_image'
    real_time_img_dir = f'./results/real_time/{file_name+"_onnx"}/real_time_image'
    ...
    clr = CLRNetDemo('./49_230206.onnx.jetson')
