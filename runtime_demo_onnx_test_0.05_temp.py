...
if __name__ == "__main__":
    ...
    result_img_dir = f'./results/real_time/{file_name+"_trained_onnx"}/test' # image save directory
    original_img_dir = f'./results/real_time/{file_name+"_trained_onnx"}/original_image'
    real_time_img_dir = f'./results/real_time/{file_name+"_trained_onnx"}/real_time_image'
